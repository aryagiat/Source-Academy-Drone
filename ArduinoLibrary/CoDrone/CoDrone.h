...
enum Request
{
  ...
  // ¼¾¼­
  Req_ImuRawAndAngle = 0x50, ///< IMU Raw + Angle 80
  Req_Pressure,              ///< ¾Ð·Â ¼¾¼­ µ¥ÀÌÅÍ 81
  Req_ImageFlow,             ///< ImageFlow 82
  Req_Button,                ///< ¹öÆ° ÀÔ·Â 83
  Req_Battery,               ///< ¹èÅÍ¸® 84
...
public:
  ...
  //--------------------------Hacked Getter function------------------------------------//
  void getBatteryData(uint8_t *pData);
  void getPressureTempData(uint8_t *pData);
...
private:
  ...
  byte devAddressCheckEEPROMStandIn;
  byte devAddressConnectedEEPROMStandIn[6];
